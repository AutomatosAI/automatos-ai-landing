...
const Cookies = () => {
    return (
        <div className="min-h-screen bg-background">
            <SEO
                title="Cookie Policy"
                description="How Automatos AI uses cookies and tracking technologies."
                path="/cookies"
                structuredData={[
                    breadcrumbSchema([
                        { name: "Home", url: "/" },
            ...
            <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="prose prose-gray dark:prose-invert max-w-none space-y-6 text-muted-foreground">
                        ...
                        <p>
                            If you have any questions about our use of cookies, please contact us at: <a href="mailto:privacy@automatos.app" className="text-primary hover:underline">privacy@automatos.app</a>
                        </p>
                    </div>
                </div>
            </main>
