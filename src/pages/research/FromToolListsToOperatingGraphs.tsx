            ...
            <div className="research-content max-w-3xl mx-auto">
              ...
              <ul>
                <li>
                  ...
                  operations, marketplace, monitoring)
                </li>
                <li>
                  Workspace tools (file system, code execution, deployment,
                  browser, search)
                </li>
                <li>
                  User-installed integrations (CRM, calendar, email, custom
                  APIs)
                </li>
                <li>Marketplace skills, each with its own tool requirements</li>
                <li>Specialist agents, each with their own assigned tools</li>
                <li>
                  Cross-cutting infrastructure (RAG, knowledge graph, vector
              ...
              <p>
                This is the core engineering insight that has driven the last
                six months of architecture work:{" "}
                <strong>
                  attention is a scarce resource, and tokens are how we ration
                  it.
                </strong>
              </p>

              <h2>Attention budgets and the menu problem</h2>
              <p>
              ...
              <p>
                ...
                <em>active capability</em> — is the real measure of agent
                intelligence in the operations regime.
              </p>
              <p>
              ...
              <p>
                The academic community has been working this question from
                several angles, and the trajectory is clearer in retrospect
                than it felt at the time.
              </p>
              <p>
                <strong>Toolformer</strong> (Schick et al., 2023) showed that
                language models can be fine-tuned to call APIs at the right
                moment and integrate results into subsequent reasoning. The
                contribution wasn't a tool-calling protocol; it was the
                demonstration that tool-use behavior can be learned by the
                model itself.{" "}
                <a
              ...
              <p>
                Read together, the research is converging on a simple thesis:{" "}
                <strong>
                  the next generation of agents won't survive on flat lists.
                  They'll need learned structure across tools, skills, and
                  memory.
                </strong>
              </p>
              <p>
              ...
              <p>
                We worked the problem in layers, each one solving a specific
                constraint that surfaced when the previous one was in place.
              </p>
              ...
              <p>
                This was the first move from "agents own tools" to "the
                platform brokers tools."
              </p>
              ...
              <p>
                Even with a clean platform action layer, we hit the next
                tradeoff: should every action be a directly-callable tool
                schema, or should they sit behind a single dispatcher (
              ...
              <p>
                ...
                explicit tradeoffs per tool.
              </p>

              <h3>Configuration substrate stability</h3>
              <p>
              ...
              <ul>
                <li>
                  <strong>Auto</strong> — the orchestrator's model
                </li>
                <li>
                  <strong>System</strong> — background services (RAG, memory
              ...
              <p>
                ...
                infrastructure, the regressions stopped being mysterious.
              </p>
              <p>
                This is where we were standing when the real problem became
                visible.
              </p>
              ...
              <ul>
                <li>
                  <strong>Tool-schema routing</strong> — which{" "}
                  <em>callable</em> tools the model receives in its
              ...
              <p>
                Separating them lets the callable-schema set stay small,
                stable, and high-signal, while the described-capability set
              ...
              <p>
                ...
                <strong>agent-specific operating graphs</strong>.
              </p>
              <p>Conceptually:</p>
              <ul>
                <li>
              ...
              <p>So the direction isn't "put more in the prompt."</p>
              <p>It's the opposite.</p>
              <p>
                The direction is to build a{" "}
                <strong>pre-prompt intelligence layer</strong> that decides
                what deserves to enter the prompt at all.
              </p>
              <p>That layer combines:</p>
              <ul>
                <li>
                  <strong>Semantic indexes</strong> over tools, actions,
                  skills, and memories
                </li>
                <li>
                ...
                <li>
                  ...
                  failed tool sequences, with feedback from execution
                  telemetry
                </li>
                <li>
              ...
              <h2>Closing</h2>
              <p>
                An AI operating system should not ask the model to remember
                the whole operating system.
              </p>
              <p>
                It should give the model the right part of the operating
                system at the moment.
              </p>
              <p>
                Tool lists got us to chatbots. They won't get us to agents
                that run businesses.
              </p>
              <p>
...
export default FromToolListsToOperatingGraphs;
